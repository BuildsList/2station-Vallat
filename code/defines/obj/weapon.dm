...
/obj/item/weapon/card/id/syndicate
	name = "agent card"
	desc = "Shhhhh."
	access = list(ACCESS_MAINT_TUNNELS_TG)
...
/obj/item/weapon/caution/danger
	desc = "Caution! Danger Area!"
	name = "danger area sign"
	icon = 'janitor.dmi'
	icon_state = "cautionsec"
...
/obj/item/weapon/flavor
	...
	colour = "beige" //colour the icon should take on when this is applied.  Also shown when it is mixed in.
