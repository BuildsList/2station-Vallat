...
/* HSL procs
	These procs convert between RGB (red, green, blu) and HSL (hue, saturation, light)
		colour spaces. The algorithms used for these procs were found at
		http://www.paris-pc-gis.com/MI_Enviro/colours/colour_models.htm
	...
	hsl2rgb(hue, sat, lgh, scale = 240)
		...
		ARGS:
			...
			scale	- high end of the HSL values. Some programs (like BYOND Dream Maker)
						...
						DEFAULT: 240
		RETURNS:
			RGB colour string in RRGGBB format.

	rgb2hsl(red, grn, blu, scale = 240)
		Returns the HSL colour string of an RGB colour
...
proc
	hsl2rgb(hue, sat, lgh, scale = 240)
		/* Returns the RRGGBB format of an HSL colour string
			algorithm from http://www.paris-pc-gis.com/MI_Enviro/colours/colour_models.htm
		ALTERNATE FORMAT:
			hsl2rgb(HSL, scale)
		ARGS:
			hue		- hue
	...
	rgb2hsl(red, grn, blu, scale = 240)
		/* Returns the HSL colour string of a RGB colour
			algorithm from http://www.paris-pc-gis.com/MI_Enviro/colours/colour_models.htm
		ALTERNATE FORMAT:
			rgb2hsl(RGB, scale)
		ARGS:
