...
/area/derelict/temple
	name = "\improper Abandoned Temple"
	icon_state = "temple"

/area/derelict/ladder
	name = "\improper Abandoned Ladder"
	icon_state = "ladder"

/area/derelict/prison
	name = "\improper Abandoned Prison Station"
	icon_state = "prison"

/area/derelict/metro
	name = "\improper Abandoned Underground"
	icon_state = "metro"

/area/derelict/dormstst
	name = "\improper Abandoned Communist station"
	icon_state = "dormstat"

/area/derelict/labstst
	name = "\improper Abandoned Communist Laboratories"
	icon_state = "labstat"

/area/derelict/strnge
