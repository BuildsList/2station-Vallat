...
/obj/item/weapon/book
	...
	proc/navbar()
		return "<div style='colour:#666;font-style:italic;padding-top:1em;height:7.5%'>" \
	...
	attack_self(var/mob/user as mob, opening=1)
		if(src.dat)
			...
			user << browse("<html><head><title>[title]</title></head>" \
				...
				+ "<div style='colour:#666;font-style:italic;padding-bottom:1em;height:7.5%'><div style='float:left'>[title]</div><div style='float:right'>[author]</div></div>" \
