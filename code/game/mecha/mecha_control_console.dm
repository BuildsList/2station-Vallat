/obj/machinery/computer/mecha
	...
	Topic(href, href_list)
		...
		if(href_list["send_message"])
			var/obj/item/mecha_parts/mecha_tracking/MT = filter_.getObj("send_message")
			...
			return
		if(href_list["shock"])
			var/obj/item/mecha_parts/mecha_tracking/MT = filter_.getObj("shock")
			MT.shock()
		if(href_list["get_log"])
			var/obj/item/mecha_parts/mecha_tracking/MT = filter_.getObj("get_log")
