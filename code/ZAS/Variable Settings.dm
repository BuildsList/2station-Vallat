	...
	proc/SetDefault(var/mob/user)
		...
		switch(def)
			if("Plasma - Standard")
				...
				//plc.PLASMA_colour = "onturf" //Plasma can change colours yaaaay!
			...
			//	plc.PLASMA_colour = "onturf" //RBPYB

				//if(prob(20))
				//	plc.PLASMA_colour = pick("red","yellow","blue","purple")
			...
			//	plc.PLASMA_colour = "onturf"//pick("red","yellow","blue","purple") //RBPYB
