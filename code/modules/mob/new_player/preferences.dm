...
//proc for making sentences Do This As An Example. For names.
	...
	proc/ShowChoices(mob/user)
		...
		if((user.client) && (user.client.holder) && (user.client.holder.rank) && (user.client.holder.level >= 5))
			dat += "<hr><b>OOC</b><br>"
			dat += "<a href='byond://?src=\ref[user];preferences=1;ooccolour=input'>Change colour</a> <font face=\"fixedsys\" size=\"3\" colour=\"[ooccolour]\"><table style='display:inline;'  bgcolour=\"[ooccolour]\"><tr><td>__</td></tr></table></font>"
	...
	//	if(!IsGuestKey(user.key))//Seeing as it doesn't do anything, it may as well not show up.
		...
		dat += "<a href='byond://?src=\ref[user];preferences=1;hair=input'>Change colour</a> <font face=\"fixedsys\" size=\"3\" colour=\"#[num2hex(r_hair, 2)][num2hex(g_hair, 2)][num2hex(b_hair, 2)]\"><table style='display:inline;' bgcolour=\"#[num2hex(r_hair, 2)][num2hex(g_hair, 2)][num2hex(b_hair)]\"><tr><td>__</td></tr></table></font> "

		dat += "Style: <a href='byond://?src=\ref[user];preferences=1;h_style=input'>[h_style]</a>"

		dat += "<hr><b>Facial</b><br>"

		dat += "<a href='byond://?src=\ref[user];preferences=1;facial=input'>Change colour</a> <font face=\"fixedsys\" size=\"3\" colour=\"#[num2hex(r_facial, 2)][num2hex(g_facial, 2)][num2hex(b_facial, 2)]\"><table  style='display:inline;' bgcolour=\"#[num2hex(r_facial, 2)][num2hex(g_facial, 2)][num2hex(b_facial)]\"><tr><td>__</td></tr></table></font> "

		dat += "Style: <a href='byond://?src=\ref[user];preferences=1;f_style=input'>[f_style]</a>"

		dat += "<hr><b>Eyes</b><br>"
		dat += "<a href='byond://?src=\ref[user];preferences=1;eyes=input'>Change colour</a> <font face=\"fixedsys\" size=\"3\" colour=\"#[num2hex(r_eyes, 2)][num2hex(g_eyes, 2)][num2hex(b_eyes, 2)]\"><table  style='display:inline;' bgcolour=\"#[num2hex(r_eyes, 2)][num2hex(g_eyes, 2)][num2hex(b_eyes)]\"><tr><td>__</td></tr></table></font>"
	...
	proc/SetChoices(mob/user, limit = 17, list/splitJobs, width = 550, height = 500)
		...
		for(var/datum/job/job in job_master.occupations)
			...
			if(jobban_isbanned(user, rank))
				...
				continue
			if((job_TH_low & ASSISTANT) && (rank != "Assistant"))
...
*/
		...
		if(link_tags["ooccolour"])
			var/ooccolour = input(user, "Please select OOC color.", "OOC color") as color
