...
/proc/create_border_image(icon/input, border_colour = "#000000", fill_colour = "#000000", border_alpha = 255, fill_alpha = 255)
	...
	I.Mapcolours(border_colour, fill_colour, rgb(0, 0, 0, border_alpha), rgb(0, 0, 0, fill_alpha), "#00000000")
...
//
//   Take a source icon, convert into a mask,
//  and border. colour them according to args,
//  and do_animate.
//
//----------------------------------------

/proc/do_animate_rune_full(icon/input, rr1, rg1, rb1, ra1, rr2, rg2, rb2, ra2, br1, bg1, bb1, ba1, br2, bg2, bb2, ba2, ar1, ag1, ab1, aa1, ar2, ag2, ab2, aa2, or1, og1, ob1, oa1, or2, og2, ob2, oa2, frames)
...
/proc/do_animate_rune(icon/input, rune_colour = "#00000000", border_colour = "#c8000000", rune_colour2 = "#00000000", border_colour2 = "#d8380000", alpha = 255, alpha2 = 255, frames = rune_animation)
	...
	return do_animate_rune_full(input, rr1, rg1, rb1, ra1, rr2, rg2, rb2, ra2, br1, bg1, bb1, ba1, br2, bg2, bb2, ba2, 0, 0, 0, alpha, 0, 0, 0, alpha2, 0, 0, 0, 0, 0, 0, 0, 0, frames)


/proc/indo_animate_rune(icon/input, rune_colour = "#00000000", border_colour = "#c8000000")
	var/icon/base = create_border_image(input, "#00ff0000", "#ff000000")

	base.Mapcolours(rune_colour, border_colour, "#00000000", "#000000ff", "#00000000")
...
/proc/get_rune(rune_bits, do_animated = 0)
	var/lookup = "[rune_bits]-[do_animated]"
	...
	if(do_animated == 1)
		result = do_animate_rune(base)

	else
		result = indo_animate_rune(base)
...
/mob/verb/create_rune_custom(rune as num, colour1 as colour, border1 as colour, colour2 as colour, border2 as colour, alpha1 as num, alpha2 as num)
	...
	var/obj/o = new(locate(x, y, z))
	o.icon = do_animate_rune(I, colour1, border1, colour2, border2, alpha1, alpha2)
...
/mob/verb/spam()
	for(var/turf/t in range(4))
		...
		var/obj/o = new(t)
		o.icon = do_animate_rune_full(I, rand(0, 255), rand(0, 255), rand(0, 255), rand(-255, 255),
