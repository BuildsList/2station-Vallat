...
//  after calling Mapcolours on it. The
...
/proc/Mapcolours_interpolate(icon/input, ratio,
...
/proc/Mapcolours_interpolate_list(icon/I, ratio, list/colours)
	var/list/c[10]
	...
	return Mapcolours_interpolate(I, ratio,
...
//----------------------------------------
//
//   Take the source image, and return an do_animated
//  version, that transitions between the provided
//  colour mappings, according to the provided
//  pattern.
//
//   colours should be in a format suitable for
//  Mapcolours_interpolate_list, and frames should
...
/proc/generate_colour_animation(icon/icon, list/colours, list/frames)
	...
	for(var/frame in frames)
		var/icon/I = Mapcolours_interpolate_list(icon, frame[1], colours)
