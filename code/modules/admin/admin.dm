...
//Regular jobs
	...
	//Non-Human (Green)
		counter = 0
		jobs += "<table cellpadding='1' cellspacing='0' width='100%'>"
		jobs += "<tr bgcolour='ccffcc'><th colspan='[length(nonhuman_positions)]'><a href='?src=\ref[src];jobban3=nonhumandept;jobban4=\ref[M]'>Non-human Positions</a></th></tr><tr align='center'>"
	...
	//Misc (Grey)
		jobs += "<table cellpadding='1' cellspacing='0' width='100%'>"
		jobs += "<tr bgcolour='B5B5B5'><th colspan='10'>Misc Positions</th></tr><tr align='center'>"
			...
			if(notbannedlist.len) //at least 1 unbanned job exists in joblist so we have stuff to ban.
				...
				if(reason)
					...
					if(config.banappeals)
						M << "\red You may try to appeal this at [config.banappeals]"
...
*/
	...
	//don't strip organs
				...
				if(istype(M, /mob/living/carbon/human))
					...
					prisoner.equip_if_possible(new /obj/item/clothing/under/colour/orange(prisoner), prisoner.slot_w_uniform)
...
/*					for(var/obj/machinery/vehicle/pod/O in world)
	...
	//don't warp them if they aren't ready or are already there
						...
						if(!security)
							...
							H.equip_if_possible(new /obj/item/clothing/under/colour/orange(H), H.slot_w_uniform)
			...
			switch(href_list["secretscoder"])
				...
				if("maint_access_brig")
					for(var/obj/machinery/door/airlock/maintenance/M in world)
						if (ACCESS_MAINT_TUNNELS_TG in M.req_access)
